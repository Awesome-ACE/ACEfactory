...
def add_dataset_args(parser: argparse.ArgumentParser):
    ...
    data_group.add_argument('--dataset_path', type=str, help='Path to dataset directory containing train/validation/test CSV files')
    ...
    data_group.add_argument('--train_file', type=str,default='train.csv')
    data_group.add_argument('--valid_file', type=str,default='validation.csv')
    data_group.add_argument('--test_file', type=str,default='test.csv')
